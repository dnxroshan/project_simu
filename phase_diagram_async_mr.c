...
void main()
{
	...
	LoadAgents("/home/dnroshan/Project/networks/ring_128_2/ring_128_2_1.0.dat");
        for(n = 0;n<100;n++)
	{
                sprintf(ofname,"/home/dnroshan/Project/output/async/phase/1.0/async_ring_128_2_1.0(%d).dat",n);
		fp = fopen(ofname,"w");
		printf("%d\n--------------------\n",n);
